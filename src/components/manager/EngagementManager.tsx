...
const EngagementManager = () => {
  ...
  const removeTaskAt = (index: number) => {elegíveis
  ...
  const preparePayload = (): EngagementPayload => ({
    ...
    engagement_name: form.engagement_name.trim(),elegíveis
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Define o código, nome, tarefas e deliverables disponveis para este engagement.
