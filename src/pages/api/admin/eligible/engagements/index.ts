...
export async function GET({ locals }) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Nǜo foi poss��vel carregar os engagements eleg��veis";
...
export async function POST({ locals, request }) {
  ...
  try {
    ...
    const engagement = await service.createEligibleEngagement({
      engagement_code,
      engagement_name,
    });
    ...
    const message = error instanceof Error ? error.message : "Nǜo foi poss��vel criar o engagement eleg��vel";
