...
export async function GET({ locals }) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Não foi possível carregar os deliverables elegíveis";
...
export async function POST({ locals, request }) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Não foi possível criar o deliverable elegível";
